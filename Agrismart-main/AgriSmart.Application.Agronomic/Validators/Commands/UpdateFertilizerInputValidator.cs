...
{
    public class UpdateFertilizerInputValidator : BaseValidator<UpdateFertilizerInputCommand>
    {
        public UpdateFertilizerInputValidator()
        {
            RuleFor(x => x).Must(AreFiltersValid).WithMessage(x => x.GetType().Name.ToString() + " parameters are invalid");
        }

        protected override bool AreFiltersValid(UpdateFertilizerInputCommand command)
        {
